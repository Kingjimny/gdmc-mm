 ...
 * window by extending the {@link android.support.v7.app.ActionBarActivity} class and setting the activity theme to
 ...
 *
 * <p>From your activity, you can retrieve an instance of {@link android.support.v7.app.ActionBar} by calling {@link
 ...
 * from those for {@link android.support.v7.app.ActionBar}.
 *
...
public abstract class ActionBar {
    ...
    /**
     * Create and return a new {@link android.support.v7.app.ActionBar.Tab}. This tab will not be included in the action bar until it
     * is added.
     *
     * <p>Very often tabs will be used to switch between {@link android.support.v4.app.Fragment} objects.  Here is a
     ...
     *
     * @return A new Tab
     * @see #addTab(android.support.v7.app.ActionBar.Tab)
     */
     ...
     * not have the feature {@link android.view.Window#FEATURE_ACTION_BAR_OVERLAY} it will resize application
     * content to fit the new space available.
     *
     * <p>If you are hiding the ActionBar through {@link android.view.View#SYSTEM_UI_FLAG_FULLSCREEN
     ...
     * have the feature {@link android.view.Window#FEATURE_ACTION_BAR_OVERLAY} it will resize application content
     * to fit the new space available.
     *
     * <p>Instead of calling this function directly, you can also cause an ActionBar using the
     * overlay feature to hide through {@link android.view.View#SYSTEM_UI_FLAG_FULLSCREEN
    ...
    /**
     * Returns a {@link android.content.Context} with an appropriate theme for creating views that will appear in
    ...
    /**
     * Listener for receiving {@link android.support.v7.app.ActionBar} navigation events.
     *
    ...
    /**
     * Listener for receiving events when {@link android.support.v7.app.ActionBar} items are shown or hidden.
     *
     * <p class="note"><strong>Note:</strong> This interface is included in the <a
     * href="{@docRoot}tools/extras/support-library.html">support library</a> for compatibility
     * with API level 7 and higher. If you're developing your app for API level 11 and higher
    ...
    /**
     * A tab in the action bar that manages the hiding and showing of {@link android.support.v4.app.Fragment}s.
     *
     * <p class="note"><strong>Note:</strong> This class is included in the <a
     * href="{@docRoot}tools/extras/support-library.html">support library</a> for compatibility
     * with API level 7 and higher. If you're developing your app for API level 11 and higher
    ...
    public static abstract class Tab {
         ...
         * #setText(CharSequence)} and {@link #setIcon(android.graphics.drawable.Drawable)}.
         *
        ...
        /**
         * Set the {@link android.support.v7.app.ActionBar.TabListener} that will handle switching to and from this tab. All tabs
    ...
    /**
     * Callback interface invoked when an {@link android.support.v7.app.ActionBar.Tab} is focused, unfocused, added, or
     * removed.
     *
     * <p class="note"><strong>Note:</strong> This interface is included in the <a
     * href="{@docRoot}tools/extras/support-library.html">support library</a> for compatibility
    ...
    public interface TabListener {
         ...
         * @param ft  A {@link android.support.v4.app.FragmentTransaction} for queuing fragment operations to execute once
