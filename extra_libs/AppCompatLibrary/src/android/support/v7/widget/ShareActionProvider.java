 ...
 *
 * <p>
 * Here is how to use the action provider with custom backing file in a {@link android.view.MenuItem}:
 * </p>
 * <pre><code>
 ...
 *      // {@link android.support.v4.view.ActionProvider#onCreateActionView()} which uses the backing file name. Omit this
 ...
 *
 * <p>For information about how to use {@link android.support.v7.widget.ShareActionProvider}, see the
...
public class ShareActionProvider extends ActionProvider {
    ...
    /**
     * Policy that delegates to the {@link android.support.v7.widget.ShareActionProvider.OnShareTargetSelectedListener}, if such.
     */
