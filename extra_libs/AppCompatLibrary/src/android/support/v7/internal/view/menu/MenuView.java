...
/**
 * Minimal interface for a menu view.  {@link #initialize(android.support.v7.internal.view.menu.MenuBuilder)} must be called for the menu
 * to be functional.
 *
 * @hide
 */
public interface MenuView {
    ...
    /**
     * Minimal interface for a menu item view.  {@link #initialize(android.support.v7.internal.view.menu.MenuItemImpl, int)} must be
