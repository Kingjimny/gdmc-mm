...
public abstract class ActionMode {
    ...
    /**
     * Invalidate the action mode and refresh menu content. The mode's {@link android.support.v7.view.ActionMode.Callback}
     * will have its {@link android.support.v7.view.ActionMode.Callback#onPrepareActionMode(android.support.v7.view.ActionMode, android.view.Menu)} method called. If it
    ...
    /**
     * Finish and close this action mode. The action mode's {@link android.support.v7.view.ActionMode.Callback} will have
     * its {@link android.support.v7.view.ActionMode.Callback#onDestroyActionMode(android.support.v7.view.ActionMode)} method called.
     */
    ...
    /**
     * Returns a {@link android.view.MenuInflater} with the ActionMode's context.
     */
     ...
     * {@link android.support.v7.app.ActionBarActivity#startSupportActionMode(android.support.v7.view.ActionMode.Callback)}
     ...
     *
     * <ul><li>{@link android.support.v7.view.ActionMode.Callback#onCreateActionMode(android.support.v7.view.ActionMode,
     * android.view.Menu)} once on initial creation</li>
     *
     * <li>{@link android.support.v7.view.ActionMode.Callback#onPrepareActionMode(android.support.v7.view.ActionMode, android.view.Menu)}
     * after creation and any time the {@link android.support.v7.view.ActionMode} is invalidated</li>
     *
     * <li>{@link
     * android.support.v7.view.ActionMode.Callback#onActionItemClicked(android.support.v7.view.ActionMode, android.view.MenuItem)} any time a contextual action button is
     * clicked</li>
     *
     * <li>{@link android.support.v7.view.ActionMode.Callback#onDestroyActionMode(android.support.v7.view.ActionMode)} when the action mode is
     * closed</li></ul>
     */
