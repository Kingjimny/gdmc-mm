...
class AdapterWrapper extends BaseAdapter implements StickyListHeadersAdapter {
	...
	/**
	 * Get a header_list_section view. This optionally pulls a header_list_section from the supplied
	...
	private View configureHeader(WrapperView wv, final int position) {
		...
		//if the header_list_section isn't clickable, the listselector will be drawn on top of the header_list_section
	...
	/**
	 * Returns {@code true} if the previous position has the same header_list_section ID.
	 */
